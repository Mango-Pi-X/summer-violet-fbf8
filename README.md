...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/skibibdi
```

A live public deployment of this template is available at [https://skibibdi.templates.workers.dev](https://skibibdi.templates.workers.dev)
